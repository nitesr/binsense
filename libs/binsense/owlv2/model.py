    ...
    def forward(
        ...
        Args:
            pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`):
                Pixel values.
            query_embedding (`torch.FloatTensor` of shape `(batch_size, embed_size)`):
                embedding retrieved from this model's image embedder. Pass in one query  per target image.
